...
import { validateBody, estabelecimentoSchema, abertoSchema } from '../services/validation.middleware';
...
router.patch('/:id/aberto', authenticateJWT, validateBody(abertoSchema), async (req, res) => {
  await EstabelecimentoController.setAberto(req, res);
});

...
export class PedidoController {
  ...
  static async confirmOrder(req: Request, res: Response): Promise<void> {
    ...
    //   total: number
    // }
    const { clienteId, estabelecimentoId, produtos, formaPagamento, total: totalCliente, paymentId, paymentStatus, paymentMethod } = req.body;
    
    console.log('Dados extraídos:', { clienteId, estabelecimentoId, produtos, formaPagamento, totalCliente, paymentId, paymentStatus, paymentMethod });
